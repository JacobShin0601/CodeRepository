...
;
;For example: 22.5º when pressing w:
...
Gosub, ~F6  ; Initialize based on current F6 state.
return
...
; which in turn prevents toggling of the F6 state/light:
KeyWait, F6
GetKeyState, ScrollLockState, F6, T
