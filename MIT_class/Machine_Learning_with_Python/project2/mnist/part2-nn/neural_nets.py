...
class NeuralNetwork():
    ...
    def __init__(self):
        ...
        self.input_to_hidden_weights = np.matrix('1. 1.; 1. 1.; 1. 1.') ### 3 x 2
        self.hidden_to_output_weights = np.matrix('1. 1. 1.') ### 1 x 3
        self.biases = np.matrix('0.; 0.; 0.') ### 3 x 1
    ...
    def train(self, x1, x2, y):
        ...
        # Compute gradients
        output_layer_error =  (activated_output - y) * output_layer_activation_derivative(output)  # 1 by 1, derivative of (1/2*(activated_output - y)^2)
